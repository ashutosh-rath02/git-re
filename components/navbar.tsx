...
export default async function Navbar() {
  ...
  return (
    <nav className="fixed top-0  backdrop-blur-sm z-50 max-w-screen-2xl mx-auto sm:px-20 md:px-8 lg:px-20 px-8 m-2 p-4 w-full flex items-center justify-between">
